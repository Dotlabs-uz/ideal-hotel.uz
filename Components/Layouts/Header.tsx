    ...
    <header className="fixed top-0 left-0 md:px-0 w-full backdrop-blur-md bg-black/60 text-white z-40">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          {/*    <button className="px-4 py-2 cursor-pointer border border-white text-white hover:bg-white hover:text-black rounded">*/}
          {/*      {translation.Header.Book}*/}
          {/*    </button>*/}
          {/*</a>*/}
          <a href={`/${lang}/booking`} rel="noopener noreferrer">
            <button className="px-4 py-2 cursor-pointer border border-white text-white hover:bg-white hover:text-black rounded">
              {translation.Header.Book}
            </button>
          </a>
